...
<div id="wrapper">
    ...
    <div>
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">My Tutorials</h1>
                    <ol class="breadcrumb">
                        <li class="active">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody id="tbody1">
                                <c:forEach var="element" items="${tutorials}">
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <form:form method="post" action="/edittutorial">
                                                <input type="hidden" id="tutorialId" name="tutorialId" value="${element.id}">
